  ...
  'use strict'
	...
	var myChart = new Chart( ctx, {
		...
		data: {
			...
			type: 'line',
			datasets: [ {
				data: [83,56,85,62,75,45, 86, 56,90,0],
				label: 'Bitcon',
				backgroundColor: 'rgb(12, 167, 236,0.2)',
				borderColor: '#0ca7ec',
				borderWidth: '2',
				pointBorderColor: 'transparent',
				pointBackgroundColor: 'transparent',
	...
	var myChart = new Chart( ctx, {
		...
		data: {
			...
			type: 'line',
			datasets: [ {
				data: [85,78,52,78,56,78,69,84,60,0],
				label: 'Bitcon',
	...
	var myChart = new Chart( ctx, {
		...
		data: {
			...
			type: 'line',
			datasets: [ {
				data: [56,68,36,45,29,58,37,56,60,0],
				label: 'Bitcon',
