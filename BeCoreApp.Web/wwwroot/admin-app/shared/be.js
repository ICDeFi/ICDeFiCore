var be = {
    ...
    getType: function (type) {
        if (type == 1)
            return '<span class="badge badge-primary-light">New</span>';
        else if (type == 2)
            return '<span class="badge badge-secondary-light">Watched</span>';
        else
            return '<span class="badge badge-success-light">Responded</span>';
    },
    getTransactionType: function (type) {
        if (type == 1)
            return '<span class="badge badge-primary-light">New</span>';
        else if (type == 2)
            return '<span class="badge badge-success-light">Approve</span>';
        else
