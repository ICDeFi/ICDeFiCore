( function ( $ ) {
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                data: [ 0, 7, 3, 5, 2, 10, 7 ],
                label: "Expense",
                backgroundColor: 'rgba(34, 5, 191,.6)',
                borderColor: 'rgba(34, 5, 191,0.6)',
                borderWidth: 3.5,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(34, 5, 191,0.9)',
                    }, ]
        },
        options: {
            responsive: true,
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                ...
                borderColor: 'rgba(34, 5, 191)',
                borderWidth: 3,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(34, 5, 191)',
                    }, {
                label: "Electronics",
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(34, 5, 191,.9)",
                    borderWidth: "1",
                    backgroundColor: "rgba(34, 5, 191,.7)",
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [
			{
				...
				borderColor: "rgba(34, 5, 191, 0.9)",
				borderWidth: "0",
				backgroundColor: "rgba(34, 5, 191, 0.7)"
						},
			{
				label: "My Second dataset",
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(34, 5, 191, 0.6)",
                    borderWidth: "1",
                    backgroundColor: "rgba(34, 5, 191, 0.4)"
                            },
                {
                    label: "My Second dataset",
            ...
            datasets: [
                {
                    ...
                    borderColor: "rgba(34, 5, 191, 0.9)",
                    borderWidth: "0",
                    backgroundColor: "rgba(34, 5, 191, 0.8)"
                            }
                        ]
        },
        options: {
	...
	gradientStroke1.addColorStop(1, '#2205bf');
	...
	gradientStroke.addColorStop(0, 'rgba(34, 5, 191,0.6)');
	gradientStroke.addColorStop(1, 'rgba(34, 5, 191,0.6)');
    var myChart = new Chart( myCanvas, {
		type: 'line',
		data: {
	...
	gradientStroke.addColorStop(0, '#2205bf');
	gradientStroke.addColorStop(1, '#2205bf');
    var myChart = new Chart(ctx, {
		type: 'line',
		data: {
